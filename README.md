...
**For security reasons, full infrastructure code (Terraform, Kubernetes, Helm) is not included in this public repository.  
What is shown here are placeholders, structure, and safe, autogenerated files.**

**If you are a recruiter and would like access to the complete setup, feel free to reach out via email.**
